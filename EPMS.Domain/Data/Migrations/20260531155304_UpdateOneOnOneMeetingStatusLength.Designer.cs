...
namespace EPMS.Domain.Data.Migrations
{
    ...
    [Migration("20260531155304_UpdateOneOnOneMeetingStatusLength")]
    partial class UpdateOneOnOneMeetingStatusLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Auth.PasswordResetOtp", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PasswordResetOtps", "auth");
                });

            modelBuilder.Entity("EPMS.Domain.Entities.Auth.PasswordResetRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PasswordResetRequests", "auth");
                });
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.EmployeeInfo.EmployeeEmploymentHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EmployeeEmploymentHistories", "hr");
                });
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.EmployeeInfo.EmployeeSalaryHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EmployeeSalaryHistories", "hr");
                });
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Performance.Appraisal", b =>
                {
                    ...
                    b.Property<string>("FormulaWeights")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Performance.AppraisalCycle", b =>
                {
                    ...
                    b.Property<DateOnly>("EvaluationStartDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Performance.AppraisalStatusHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AppraisalStatusHistories", "perf");
                });
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Performance.EmployeeKPI", b =>
                {
                    ...
                    b.HasIndex("EmployeeId", "KPIId", "CycleId")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Performance.PIPStatusHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PIPId", "ChangedAt");

                    b.ToTable("PIPStatusHistories", "perf");
                });
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Performance.PositionFormTemplate", b =>
                {
                    ...
                    b.HasIndex("PositionId", "FormTemplateId")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Shared.DocumentAttachment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DocumentAttachments", "shared");
                });

            modelBuilder.Entity("EPMS.Domain.Entities.App.Notification", b =>
                {
                    b.HasOne("EPMS.Domain.Entities.Auth.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.EmployeeInfo.EmployeeProfile", b =>
                {
                    b.HasOne("EPMS.Domain.Entities.Auth.User", null)
                        .WithOne("Profile")
                        .HasForeignKey("EPMS.Domain.Entities.EmployeeInfo.EmployeeProfile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("EPMS.Domain.Entities.EmployeeInfo.EmployeeSalaryHistory", b =>
                {
                    b.HasOne("EPMS.Domain.Entities.Auth.User", "ApprovedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Performance.Appraisal", b =>
                {
                    ...
                    b.HasOne("EPMS.Domain.Entities.EmployeeInfo.EmployeeProfile", "ManagerReviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Performance.EmployeeKPI", b =>
                {
                    ...
                    b.HasOne("EPMS.Domain.Entities.Performance.EntityKPI", "EntityKPI")
                        .WithMany()
                        .HasForeignKey("EntityKPIId");
            ...
            modelBuilder.Entity("EPMS.Domain.Entities.Shared.DocumentAttachment", b =>
                {
                    b.HasOne("EPMS.Domain.Entities.Auth.User", "UploadedBy")
                        .WithMany()
