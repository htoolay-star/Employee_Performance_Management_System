...
public class CreateQuestionRatingScaleLevelValidator : AbstractValidator<CreateQuestionRatingScaleLevelDto>
{
    public CreateQuestionRatingScaleLevelValidator()
    {
        RuleFor(x => x.Rating)
            .GreaterThan(0)
