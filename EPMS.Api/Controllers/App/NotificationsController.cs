...
public class NotificationsController : ApiControllerBase
{
    ...
    [HttpGet("user/{userId}")]
    public async Task<ActionResult<SuccessResponse<IEnumerable<NotificationDto>>>> GetByUserId(long userId)
    {
    ...
    public async Task<ActionResult<SuccessResponse<IEnumerable<NotificationDto>>>> GetUnread(long userId)
    {
